    ...
    this.vss
      ...
      .subscribe((data) => {
        ...
        for (let val of data['centerDetails']) {
          ...
          day1Obj['age'] = val['sessions'][2]['age'];
          day1Obj['dose1_capacity'] = val['sessions'][2]['dose1_capacity'];
          day1Obj['dose2_capacity'] = val['sessions'][2]['dose2_capacity'];
          day1Obj['date'] = val['sessions'][2]['date'];
          day1Obj['slots'] = val['sessions'][2]['slots'];
          day1Obj['vaccine_name'] = val['sessions'][2]['vaccine'];
          day1Obj['vaccine_cost'] = val['vaccine_cost']['cost'];
          console.log(day1Obj);
          this.detailsOfDay3.push(day1Obj);
        }
        console.log(this.detailsOfDay3);
      });
  }
}
